...
function build() {
    cmd.get(
        `jspm build src/build/${product}/main.js --production dist/espa/${product}/${releaseJson.version}/main.js && jspm build src/build/${product}/main.js dist/espa/${product}/${releaseJson.version}/main.min.js --production --minify`,
